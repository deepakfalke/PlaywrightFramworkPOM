...
- Name: flipcartJsonDataDrivenExcel.spec.ts >> json dd test >> each record 2 >> Verify page Open login
- Location: tests\flipcartJsonDataDrivenExcel.spec.ts:44:18
...
- generic [ref=e3]:
  ...
  - generic [ref=e162]:
    ...
    - generic [ref=e168]:
      - generic [ref=e169]:
        - textbox [active] [ref=e170]: deepfalk3e3434#1@gmail.com
  ...
  - contentinfo [ref=e178]:
    - generic [ref=e180]:
      ...
      - generic [ref=e254]:
        ...
        - generic [ref=e263]:
          - img [ref=e264]
          - link "Help Center" [ref=e265] [cursor=pointer]:
            - /url: /helpcentre?otracker=footer_navlinks
